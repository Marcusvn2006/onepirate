...
const Home = () => {
  return (
    ...
    <div className="divMaster">
      ...
      <h3>Desfrute de ofertas secretas com até -70% de desconto
         nos melhores hotéis de luxo todos os domingos.  </h3>

      
      <div className="firstImg">
    <img src={toti} alt="Imagens dos espaços disponibilizados para os hospedes" />
